...
class Markets(ScannerScraper):
    ...
    VALID_MARKETS = list(get_args(MARKET_LITERAL))
    ...
    def get_markets(
        ...
        """
        self._validate_choice(market, self.VALID_MARKETS)
        self._validate_choice(sort_by, list(self.SORT_CRITERIA.keys()))
        self._validate_choice(sort_order, ["asc", "desc"])
