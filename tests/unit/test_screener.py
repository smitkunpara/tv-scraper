...
class TestBuildPayload:
    ...
    def test_payload_with_filters(self) -> None:
    ...
    def test_payload_with_sort(self) -> None:
        """Test payload with sort."""
        scraper = Screener()
        payload = scraper._build_payload(
            fields=["name", "close"],
            market="america",
    ...
    def test_payload_with_symbols(self) -> None:
        """Test payload with symbols."""
        scraper = Screener()
    ...
    def test_payload_with_filter2(self) -> None:
        """Test payload with filter2."""
        scraper = Screener()
