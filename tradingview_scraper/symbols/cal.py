        ...
        for event in response.json()["data"]:
            ...
            if not values:
                earnings_event = EarningsEvent(
                    ...
                    # event_data[1] is earnings_release_date (used for filtering, not in TypedDict)
                    logoid=event_data[2] or None,
                    name=event_data[3] or None,
                    description=event_data[4] or None,
                    earnings_per_share_fq=event_data[5] or None,
                    earnings_per_share_forecast_next_fq=event_data[6] or None,
                    eps_surprise_fq=event_data[7] or None,
                    eps_surprise_percent_fq=event_data[8] or None,
                    revenue_fq=event_data[9] or None,
                    revenue_forecast_next_fq=event_data[10] or None,
                    market_cap_basic=event_data[11] or None,
                    earnings_release_time=event_data[12] or None,
                    earnings_release_next_time=event_data[13] or None,
                    earnings_per_share_forecast_fq=event_data[14] or None,
                    revenue_forecast_fq=event_data[15] or None,
                    fundamental_currency_code=event_data[16] or None,
                    market=event_data[17] or None,
                    earnings_publication_type_fq=event_data[18] or None,
                    earnings_publication_type_next_fq=event_data[19] or None,
                    revenue_surprise_fq=event_data[20] or None,
                    revenue_surprise_percent_fq=event_data[21] or None,
                )
